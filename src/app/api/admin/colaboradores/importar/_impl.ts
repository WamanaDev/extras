/**
 * Implementação de `POST /api/admin/colaboradores/importar` (API-ADM-COL-004).
 *
 ...
 * Ver `_conflitos.md` (mesmo padrão de `.../desbloquear/_impl.ts`).
 *
...
import { parseDataCivil } from '@/server/services/colaboradores';
